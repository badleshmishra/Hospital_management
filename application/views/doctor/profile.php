                            ...
                            <div class="row no-mp">
                                <div class="col-md-4">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title image-fluid">Dr. <?= $details->doctor_name ?> </h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the
                                                bulk of the
                                                card's
                                                content.</p>
                                            <form class="d-inline-block" action="<?= $base_url ?>Doctor/edit_profile" method="post">
                                                <input type="hidden" name="edit_id" value="<?= $details->doctor_id ?>">
                                                <button type="submit" class="btn btn-success mb-2"><span class="ti-pencil-alt"></span> Edit
                                                 Doctor</button>
                                        </form>
