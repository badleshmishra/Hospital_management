<div class="container">
    ...
    <form method="post" action="<?= base_url('Drug_department/add_department'); ?>">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="quantity_allocated" id="quantity_allocated" min="1" required>
        </div>

        <div class="form-group">
            <label for="remaining_quantity">Remaining Quantity:</label>
            <input type="number" class="form-control" name="remaining_quantity" id="remaining_quantity" min="0" required>
        </div>

        <div class="form-group">
            <label for="allocated_by">Allocated By:</label>
            <input type="text" class="form-control" name="allocated_by" id="allocated_by" required>
        </div>

        <div class="form-group">
            <label for="allocation_date">Allocation Date:</label>
            <input type="date" class="form-control" name="allocation_date" id="allocation_date" required>
        </div>
